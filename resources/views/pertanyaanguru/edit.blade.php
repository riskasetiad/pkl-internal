                ...
                <div class="card-body">
                    ...
                    @method('put')
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="basic-default-name" @error('pertanyaan') is-invalid @enderror" name="pertanyaan" value="{{ $pertanyaanGuru->pertanyaan }}">
                            </div>
                            @error('pertanyaan')
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <select id="defaultSelect" class="form-select" @error('id_kompetensi') is-invalid @enderror" name="id_kompetensi" value="{{ $pertanyaanGuru->id_kompetensi }}">
